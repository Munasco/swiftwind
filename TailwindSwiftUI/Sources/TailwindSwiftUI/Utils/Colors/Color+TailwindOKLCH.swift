...
extension Color {
    private struct TailwindOKLCHParsedColor {
        let l: Double
        let c: Double
        let h: Double
        let opacity: Double
    ...
    static func oklch(string rawValue: String) -> Color? {
        guard let parsed = parseTailwindOKLCHCSS(rawValue) else { return nil }
    ...
    private static func parseTailwindOKLCHCSS(_ raw: String) -> TailwindOKLCHParsedColor? {
